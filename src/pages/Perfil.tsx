              ...
              <div className="space-y-2">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-3">
                  <p className="text-blue-700 font-medium">
                    💡 <strong>IMPORTANTE:</strong> Digite apenas números corridos<br/>
                    Formato: DDD + 9 + número (exemplo: 11987654321)<br/>
                    <span className="text-red-600 font-semibold">⚠️ Se não seguir este padrão, a Mia não funcionará no WhatsApp!</span><br/>
                    Não use espaços, parênteses (), traços -, +55 ou outros símbolos.
                  </p>
                </div>
                <Input
                  id="telefone"
