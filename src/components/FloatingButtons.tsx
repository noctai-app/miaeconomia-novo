...
export const FloatingButtons = () => {
  ...
  const openWhatsApp = () => {
    window.open("https://wa.me/5511999999999?text=Olá! Gostaria de saber mais sobre a Mia Economia.", "_blank");
  };
  ...
  return (
    <>
      ...
      {showScrollTop && (
        <Button
          onClick={scrollToTop}
          className="fixed left-6 bottom-6 z-50 w-12 h-12 rounded-full bg-purple-500 hover:bg-purple-600 text-white shadow-lg transition-all duration-300 animate-fade-in"
          size="icon"
        >
