      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            <Card key={index} className={`relative ${plan.popular ? 'border-purple-500 border-2 scale-105' : 'border-gray-200'} shadow-lg hover:shadow-xl transition-all`}>
              {plan.popular && (
              ...
              <CardContent>
                ...
                <Link to="/dashboard">
                  <Button 
                    className={`w-full ${plan.popular ? 'bg-purple-500 hover:bg-purple-600' : 'bg-gray-900 hover:bg-gray-800'} text-white`}
                    size="lg"
                  >
