...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      "flex touch-none select-none transition-colors duration-300 ease-out hover:bg-purple-100/50",
