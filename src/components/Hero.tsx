      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Gerencie suas
            <span className="text-purple-500 block">finanças de forma</span>
            simples e inteligente
          </h1>
          
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            A Mia Economia é a plataforma completa para gerenciar suas finanças pessoais e empresariais. 
            Dashboard intuitivo, relatórios detalhados e agora com assistente no WhatsApp.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Link to="/login">
              <Button size="lg" className="bg-purple-500 hover:bg-purple-600 text-lg px-8 py-4">
                Começar Grátis
